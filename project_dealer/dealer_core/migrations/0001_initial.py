    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('id_lid_ventas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dealer_core.liderventas')),
            ],
        ),
        migrations.CreateModel(
            name='Venta',
            fields=[
                ...
                ('id_comision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dealer_core.comision')),
                ('id_ej_ventas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dealer_core.ejecutivoventas')),
                ('id_lid_ventas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dealer_core.liderventas')),
            ],
        ),
    ]
